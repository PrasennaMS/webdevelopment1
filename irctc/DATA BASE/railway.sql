...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1083929660ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="626">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=railway&table=registers">`railway`.`registers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=railway&table=normalbooking">`railway`.`normalbooking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=railway&table=fastbooking">`railway`.`fastbooking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=railway&table=fast_booking">`railway`.`fast_booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=railway&table=route">`railway`.`route`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sms&table=staffreg">`sms`.`staffreg`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sms&table=register">`sms`.`register`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sms&table=admin">`sms`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=railway&table=train_registeraton">`railway`.`train_registeraton`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project&table=train_registeraton">`project`.`train_registeraton`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5c644179494a51427554735741622a3f">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="626"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
